  ...
  const steps = [
    {
      ...
      description: "Simply forward any suspicious email to scan@safemail.ai",
    },
    {
      icon: <Shield className="h-8 w-8 text-white" />,
      title: "We Analyze It",
      description: "Our AI scans for phishing attempts, malicious links, and dangerous attachments",
    },
    {
      icon: <CheckCircle className="h-8 w-8 text-white" />,
      title: "Get Instant Results",
      description: "Receive a detailed security report within minutes",
    },
  ]
      ...
      {steps.map((step, index) => (
        <div key={index} className="flex flex-col items-center text-center">
          ...
          {index < steps.length - 1 && (
            <div className="hidden md:block absolute transform translate-x-[160px]">
